...
O modelo escolhido junta as três coisas e resolve o que você pediu — *convidar*, não entregar:
...
## 3. Especificação técnica — copie para a gráfica
...
3. **Verniz brilhante em cima do QR atrapalha a leitura.** O reflexo cega a câmera em ângulo. O verniz localizado é só nos elementos laranja e no logo — **o painel do QR fica fosco**. Deixe isso explícito no pedido.
...
>
> Preciso de **prova de cor** antes da tiragem — a peça tem chapada escura e um laranja de marca que preciso conferir. Podem me passar prazo e valor com e sem o soft touch?
...
## 6. Como entregar — é aqui que vira convite
...
## 7. Peça digital — mensagem pronta

O QR no WhatsApp é para quando a imagem for mostrada na tela para outra pessoa, ou impressa. **Na conversa, o link vai no texto** — ninguém escaneia a própria tela.

> Oi, [nome]! Aqui é o Ícaro, criei o ArenaHub — um sistema de gestão feito pra arena, não pra academia de musculação adaptada.
>
...
Uma observação de precisão: o PDF sai com 305,8 × 156 mm em vez de 306 × 156 mm, porque o renderizador arredonda para pontos inteiros. São 0,2 mm dentro de uma sangria de 3 mm — não afeta o corte, que continua em 300 × 150 mm.
